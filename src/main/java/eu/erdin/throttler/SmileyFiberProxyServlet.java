...
/**
 * Copied from: https://github.com/mitre/HTTP-Proxy-Servlet
...
public class SmileyFiberProxyServlet extends FiberHttpServlet {
  ...
  /* INIT PARAMETER NAME CONSTANTS */
    ...
    private static final String ATTR_TARGET_URI =
            SmileyFiberProxyServlet.class.getSimpleName() + ".targetUri";
    private static final String ATTR_TARGET_HOST =
            SmileyFiberProxyServlet.class.getSimpleName() + ".targetHost";
  ...
  /* MISC */
     ...
     */
    private String targetUri = "http://www.tagesanzeiger.ch";
